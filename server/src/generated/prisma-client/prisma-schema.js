...
input AllergyCreateManyWithoutOwnerInput {
  create: [AllergyCreateWithoutOwnerInput!]
  connect: [AllergyWhereUniqueInput!]
}

input AllergyCreateWithoutOwnerInput {
  name: String!
  type: AllergyType!
  severity: AllergySeverity!
}
...
type AllergySubscriptionPayload {
  mutation: MutationType!
  node: Allergy
  updatedFields: [String!]
  previousValues: AllergyPreviousValues
}

input AllergySubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: AllergyWhereInput
  AND: [AllergySubscriptionWhereInput!]
  OR: [AllergySubscriptionWhereInput!]
  NOT: [AllergySubscriptionWhereInput!]
}
...
input AllergyUpdateManyMutationInput {
  name: String
  type: AllergyType
  severity: AllergySeverity
}

input AllergyUpdateManyWithoutOwnerInput {
  create: [AllergyCreateWithoutOwnerInput!]
  delete: [AllergyWhereUniqueInput!]
  connect: [AllergyWhereUniqueInput!]
  disconnect: [AllergyWhereUniqueInput!]
  update: [AllergyUpdateWithWhereUniqueWithoutOwnerInput!]
  upsert: [AllergyUpsertWithWhereUniqueWithoutOwnerInput!]
}

input AllergyUpdateWithoutOwnerDataInput {
  name: String
  type: AllergyType
  severity: AllergySeverity
}

input AllergyUpdateWithWhereUniqueWithoutOwnerInput {
  where: AllergyWhereUniqueInput!
  data: AllergyUpdateWithoutOwnerDataInput!
}

input AllergyUpsertWithWhereUniqueWithoutOwnerInput {
  where: AllergyWhereUniqueInput!
  update: AllergyUpdateWithoutOwnerDataInput!
  create: AllergyCreateWithoutOwnerInput!
}

input AllergyWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  type_in: [AllergyType!]
  type_not_in: [AllergyType!]
  severity: AllergySeverity
  severity_not: AllergySeverity
  severity_in: [AllergySeverity!]
  severity_not_in: [AllergySeverity!]
...
type Mutation {
  createAllergy(data: AllergyCreateInput!): Allergy!
  updateAllergy(data: AllergyUpdateInput!, where: AllergyWhereUniqueInput!): Allergy
  updateManyAllergies(data: AllergyUpdateManyMutationInput!, where: AllergyWhereInput): BatchPayload!
  upsertAllergy(where: AllergyWhereUniqueInput!, create: AllergyCreateInput!, update: AllergyUpdateInput!): Allergy!
  deleteAllergy(where: AllergyWhereUniqueInput!): Allergy
  deleteManyAllergies(where: AllergyWhereInput): BatchPayload!
...
type Query {
  allergy(where: AllergyWhereUniqueInput!): Allergy
  allergies(where: AllergyWhereInput, orderBy: AllergyOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Allergy]!
  allergiesConnection(where: AllergyWhereInput, orderBy: AllergyOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): AllergyConnection!
...
input SitteCreateOneWithoutAllergiesInput {
...
input SitteCreateWithoutAllergiesInput {
  firstName: String!
  lastName: String!
  birthday: DateTime
  owner: UserCreateOneWithoutSittesInput!
...
input SitteUpdateOneRequiredWithoutAllergiesInput {
  create: SitteCreateWithoutAllergiesInput
...
input SitteUpdateWithoutAllergiesDataInput {
  firstName: String
  lastName: String
  birthday: DateTime
  owner: UserUpdateOneRequiredWithoutSittesInput
...
input SitteUpsertWithoutAllergiesInput {
  update: SitteUpdateWithoutAllergiesDataInput!
  create: SitteCreateWithoutAllergiesInput!
}
...
type Subscription {
  allergy(where: AllergySubscriptionWhereInput): AllergySubscriptionPayload
